...
export function sfx(name) {
  ...
  switch (name) {
    ...
    case 'fly':     burst({ dur: 0.5, peak: 0.4, from: 480, to: 2400 }); tone({ f0: 130, f1: 430, t: 0.42, type: 'sawtooth', peak: 0.26 }); break; // 🚀 thruster ignition
    case 'flyend':  burst({ dur: 0.26, peak: 0.26, from: 1600, to: 260 }); break; // 🚀 flameout sputter
